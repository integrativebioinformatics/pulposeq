process GENOMIC_CONTEXT {
    ...
    printf 'stratum,novel_biotype,classification,class_code,ref_class,compared_gene_biotype,BambuTxClass,example_tx,gene_id,gene_name,label,panel_genes,chrom,start,end,win_s,win_e,n_tx,n_known,n_novel,n_annotated,n_novel_lnc,biotypes,figure\\n' > genomic_context_candidates.csv
    ...
    printf 'qry_id,ref_gene_id,compared_gene_name,compared_gene_biotype,chrom,start,end,win_s,win_e,strand,class_code,BambuTxClass,num_exons,samples_quantified,samples_total,quantified_samples,counts_total,full_length_support,figure\\n' > intronic_context_candidates.csv
